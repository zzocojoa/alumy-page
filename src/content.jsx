...
const CONTENT = {
  ...
  keySpecs: {
    ...
    specs: [
      { icon: "🛡️", title: "강화 알루미늄", desc: <>스크래치와 부식에 강한<br /> 외장 마감.</> },
      { icon: "🎨", title: "4가지 컬러", desc: <>공간에 어울리는<br /> 세련된 색상.</> },
      { icon: "📐", title: "안정적 거치", desc: <>미니멀한 삼각 구조로<br /> 흔들림 최소화.</> },
      { icon: "♻️", title: "지속 가능성", desc: <>리사이클링 반납 시<br /> 페이백 적용.</> },
    ],
  },
  features: [
    {
